    ...
    <div class="container mx-auto">
      <div class="h-auto lg:h-[55vh] grid items-center gap-10 lg:grid-cols-2">
        <div class="max-w-[655px] pb-20 mt-20 lg:mt-0">
          <h2
            class="text-large-title font-bold text-neutral-darkset leading-tight sm:text-4xl sm:leading-15.5 lg:text-3xl lg:leading-tight xl:text-4xl xl:leading-15.5"
          >
            Transform and query the world’s data
          </h2>

          <p class="text-heading-2 text-neutral-darker mt-5">
